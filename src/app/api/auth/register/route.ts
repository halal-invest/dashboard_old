    ...
    function validatePassword(password:string){
        ...
        try {
            ...
            if(!validatePassword(password)){
                return NextResponse.json({message:"Password should be at least 6 characters long, contains at least one capital letter and at least one number",
            status: false});
            }
            ...
            return NextResponse.json({message: "User Registration Successfully. Waiting for Verification."})
        } catch (error) {
