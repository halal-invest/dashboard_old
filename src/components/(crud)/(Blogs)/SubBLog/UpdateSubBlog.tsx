...
import { ICategory, ISubBlogs } from '@/types/common';
...
interface IProps {
    rowSelected: ISubBlogs[] | null;
    setRowSelected: any;
    refetch: () => void;
}

const UpdateSubBlog = ({ rowSelected, refetch, setRowSelected }:IProps) => {
