...
import { IGetSubCategoriesItemType, IGetSubSubCategoriesItemsType } from '@/types/common';
...
const DeleteSubSubCategory = ({ rowSelected, setRowSelected, refreshData }: IProps) => {
    ...
    const deleteHandler = async () => {
        ...
        try {
            const { data } = await axios.delete("/api/admin/sub-sub-category", {
                data: { id }
            });
