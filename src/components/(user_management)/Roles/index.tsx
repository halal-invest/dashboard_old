...
const MainContextRole = ({ roles = [], permissions = [] }: IProps) => {
    ...
    const header = (
        <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
            <h5 className="m-0">
                Roles -
                <Badge className="ml-2 pb-3" value={roles.length} size="normal" severity="success" />
            </h5>
    ...
    const leftToolbarTemplate = () => {
        return (
            <>
                ...
                <UpdateRole rowSelected={selected} setRowSelected={setSelected} refetch={refreshData} permissions={permissions} />
            </>
        );
    };
    ...
    const rightToolbarTemplate = () => {
        return (
            <>
                <CreateRole refetch={refreshData} permissions={permissions} />
            </>
        );
    };
...
export default MainContextRole;
