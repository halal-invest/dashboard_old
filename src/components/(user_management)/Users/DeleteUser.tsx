...
const DeleteUser = ({ rowSelected, refetch, setRowSelected }: { rowSelected: IProps[] | null; setRowSelected: any; refetch: () => void }) => {
    ...
    const deleteHandler = async () => {
        ...
        try {
            const { data } = await axios.delete('/api/user_management/users', {
                data: { id }
            });
